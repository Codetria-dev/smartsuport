      ...
      >
        ...
        <div className="public-header-actions flex items-center gap-3 sm:gap-4">
          ...
          <button
            ...
            className="inline-flex items-center justify-center min-h-[2.75rem] px-5 py-2.5 text-base font-semibold text-white bg-brand hover:bg-brand-dark rounded-lg shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2"
          >
            {t('getStarted')}
          </button>
        </div>
