...
export default function Button({
  ...
  const baseStyles =
    'inline-flex items-center justify-center min-h-[2.75rem] px-5 py-2.5 text-base rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed';
